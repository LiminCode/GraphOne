#pragma once
/*
* try to integrate the GraphBLAS
*/

//GraphBLAS definitions for user applications
//this is the only head file of GraphBLAS should included here
#include "../GraphBLAS/Include/GraphBLAS.h"

//below should include graph_view or static view files,
//for the new BLAS oriented graph is constructed from static_view graph
#include "graph_view.h"


//below is the Graph and the APIs, these APIs should follow the GraphBLAS' requirement
...
#define GRAPH_DEFAULT_NODE_CAP 16384            // Default number of nodes a graph can hold before resizing. 1<<14
#define GRAPH_DEFAULT_EDGE_CAP 16384            // Default number of edges a graph can hold before resizing. 1<<14
...
#define MSB_MASK (1UL << (sizeof(EntityID) * 8 - 1)) // EntityID uint64, sizeof(EntityID) return the bytes, *8 get the bits
...
#define SINGLE_EDGE(x) (x) & MSB_MASK // edge ID: 1......
// Returns edge ID.
...
} _RG_Matrix; //RG: means Redis_Graph ?
